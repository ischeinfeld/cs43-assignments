...
/* package hspec-checkers-0.1.0.2 */
#ifndef VERSION_hspec_checkers
#define VERSION_hspec_checkers "0.1.0.2"
#endif /* VERSION_hspec_checkers */
#ifndef MIN_VERSION_hspec_checkers
#define MIN_VERSION_hspec_checkers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hspec_checkers */
...
#define CURRENT_COMPONENT_ID "assignment2-0.1.0.0-9AdBh72dAIP1mxnZfmOPwJ-p3"
