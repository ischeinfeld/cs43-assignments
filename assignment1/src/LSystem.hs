...
--    generate [Draw] rules1
-- with the following 
--    generateByMap [Constant 0] ruleMap1
-- to draw the system defined by the axiom [Constant 0]
-- and the rules in ruleMap1.

-- TODO Optional: Come up with your own rules, encode them as an axiom 
-- and RuleMap, and generate the corresponding diagrams for different
-- generations.
